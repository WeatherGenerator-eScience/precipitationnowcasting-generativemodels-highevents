...
USER_FOLDER = "/home/peter/weathergenerator"
project_FOLDER = "precipitationnowcasting-generativemodels-highevents"

# When not rendering a new list with IDs, use the default option as listed below
basic_IDs_npy = "list_IDs200621_avg001mm_train.npy"

# Global variables that point to the correct directory
path_data = "/home/peter/weathergenerator/precipitationnowcasting-generativemodels-highevents/data/"
